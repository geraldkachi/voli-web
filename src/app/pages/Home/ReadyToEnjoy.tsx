...
const ReadyToEnjoy = () => {
  return (
    ...
    <div className=" text-center pt-20 text-white animate-text bg-gradient-to-b from-[#23232B] from-10% via-black via-70% to-[#0A0A0B] 10% to-90% whitespace-nowrap">
        ...
        <div className="-mt-24 md:-mt-48 lg:-mt-[350px] xl:-mt-[400px] mb-20">
            <img src="dash-ready.svg" className="skew-" alt="" />
        </div>
    </div>
