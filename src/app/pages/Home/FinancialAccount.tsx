      ...
      <section className={` w-full h-scre bg-white max-w-5xl px-3 md:mx-auto rounded-[20px]`}>
        <div className={`flex flex-row items-center justify-center gap-5`}>
          <div className="flex flex-col mb-4 mt-10 md:my-14">
            ...
            <Button title="Learn More" className="!bg-white border border-[#E5E5E6] !text-[#000024] md:mt-5 w-max  sm:hidden" suffixIcon={<><svg width="8" height="15" viewBox="0 0 8 15" fill="none" xmlns="http://www.w3.org/2000/svg">
