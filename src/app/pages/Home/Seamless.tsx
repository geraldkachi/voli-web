    ...
    return (
        <div className='max-w-5xl mx-auto'>
            ...
            <div className='grid md:grid-cols-2 gap-'>
                ...
                <div className='flex overflow- items-center justify-center'>
