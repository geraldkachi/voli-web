    ...
    <div className="py-16 w-full min-h-screen flex justify-center md:items-center bg-white">
      <div className="mx-auto max-w-xl lg:max-w-4xl flex flex-col lg:flex-row">
        ...
        <div className="relative px-5 lg:border-r-2 border-gray-100">
          <p className="absolute -top-3 md:top-0 left-10 md:left-20 text-base md:text-4xl text-indigo-600 font-bold uppercase">Error</p>
          <p className="text-9xl md:text-10xl text-gray-700 font-extrabold tracking-wider">404</p>
        </div>
        ...
        <div className="px-5">
          ...
          <Link href='/' type="button" className="mt-10 relative inline-flex items-center px-7 py-3.5 rounded border border-transparent bg-[#01C467] md:text-lg text-white font-medium">
            Go back to Homepage
          </Link>
        </div>
