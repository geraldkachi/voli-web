    ...
    <div>
      ...
      >
        <div className="flex flex-col items-center my-20">
          ...
          <p className={`text-center mt-2 text-[#00000A] text-[32px] font-extrabold md:text-[64px]`}>  We care about your Privacy <br /> as much as you do</p>
      ...
      <div className="max-w-6xl mx-auto px-3">
        <div className="flex">
          <nav className="w-1/4 bg-white p-4 hidden md:block">
            <ul className="text-[#55555C] whitespace-nowrap">
          ...
          <div className="md:w-3/4 bg-white p-3 sm:p-8 sm:ml-4">
            <section id="section1">
              ...
              <div className="text-[#808080]">
                <p className="mb-4 text-base md:text-lg">This Privacy Policy describes how Vollie ("Company", "we", "us", or "our") collects, uses, and discloses personal and non-personal information when you use our Vollie platform and services (collectively, "Services"). By accessing or using our Services, you agree to the terms of this Privacy Policy.</p>
              </div>
            </section>
