...
const PriceCards = () => {
    return (<>
        <div className="px-3 md:px-0 bg-white">
            ...
            <div
                className="hidden mt-1 space-y-3 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 md:grid-cols-3 sm:gap-6 md:max-w-5xl md:mx-auto xl:grid-cols-3 md:p-3 bg-[#FCFCFD]">
                {/* Card One */}
                <div className="bg-white rounded-lg shadow-sm flex flex-col">
                    <div className="p-6">
                        <p className="mt-8">
