...
<div className="hidden md:flex  flex-col justify-center relative py-20 pr-28 h-full !z-50">
  <div
    ...
    className={` w-72 pb-3 bg-white shadow-md absolute md:-left-0 hover:-lef-60 rounded-lg ${index == 0 || 1 || 2 && 'drop-shadow-[0_122.96px_307.39px_[]'} card transition-transform duration-500 ${isHovered ? 'hovered transform transition-all duration-75 hover:-right-60' : ''}`}
