...
const FinancialAccount = () => {
  return (
    <section className="bg-[#FFFFFF] pt-0 md:pt-5 md:pb-10 mx-3 md:mx-0">
      ...
      <div className=" w-full h-full items-start bg-inherit grid md:grid-cols-3 gap-8 pb-5">
        ...
        <div className="mx-[unset] max-[0px]:pl-0 max-sm:pl-3 max-lg:pl-10 lg:ml-40 mt-14 col-span-2">
          ...
          <div className="mt-5 mb-10 md:mb-20 text-2xl md:text-[40px] leading-[36px] md:leading-[64px] tracking-[-3%] md:font-medium font-bold">
          ...
          <div className="">
            <div className="md:col-span-2 grid sm:grid-cols-2 gap-6 h-max">
              ...
              <motion.div variants={navVariants} initial="hidden" whileInView="show" className={`p-4 md:p-8 rounded-[14px] bg-[#FFF8E5]`}>
                <div>
              ...
              <motion.div variants={navVariants} initial="hidden" whileInView="show" className={`p-4 md:p-8 rounded-[14px] bg-[#F8F5FF]`}>
                <div>
              ...
              <motion.div variants={navVariants} initial="hidden" whileInView="show" className={`p-4 md:p-8 rounded-[14px] bg-[#E3FDF1]`}>
                <div>
