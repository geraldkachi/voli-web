        ...
        <section className={` w-full h-scre mx-auto`}>
            ...
            <div className='w-full relative flex justify-center h-max mx-auto z-10 -mb-40 sm:-mb-80'>
                <motion.div ref={ref} className="flex items-center justify-center sticky top-0 -z-50">
                    <img src="next1.svg" className="hidden md:block left-10 md:-left-[26px] top-2 md:top-96 absolute z-10 cursor-pointer" alt="" />
                    <img src="next1.svg" className="hidden md:block right-5 md:-right-[26px] top-24 absolute z-10 cursor-pointer" alt="" />
